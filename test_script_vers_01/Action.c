...
/*Correlation comment - Do not change!  Original value='s10273.b1ss12743s' Name ='dwhsplit' Type ='ResponseBased'*/
	web_reg_save_param_regexp(
		"ParamName=dwhsplit",
		"RegExp=\"?[Ss]plit\"?(?:[:=]|%3D)\"?(.*?)\"?[,&%]",
		LAST);
    ...
    /*Correlation comment: Проставил вручную
    Original value='faa88786bd9cbe66dcada5bf987cb590:jHJurG2e2MjUtl3mXhK8bOvCP6NhvEDgLizSulHxarJ7InRpbWUiOjE2OTQ1NDI4NzAsInR5cGUiOiJjc3JmIiwibm9uY2UiOiIyNzAzNDFmOTVkZTFmZmQ3In0'
    Name ='Long_token_1'
    Type ='ResponseBased'*/
	web_reg_save_param_regexp(
